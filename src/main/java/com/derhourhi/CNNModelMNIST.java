    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        MultiLayerConfiguration configuration = new NeuralNetConfiguration.Builder().seed(seed)
                ...
                .layer(5, new OutputLayer.Builder().nOut(outputSize).activation(Activation.SOFTMAX)
                        .lossFunction(LossFunction.NEGATIVELOGLIKELIHOOD).build())
                .build();
        MultiLayerNetwork model = new MultiLayerNetwork(configuration);
        
        String path = "C:/Users/BD/Downloads/mnist_png-master/mnist_png.tar/mnist_png";
        ...
        int batchSize = 50;
        DataSetIterator dataSetIteratorTrain = new RecordReaderDataSetIterator(recordReaderTrain, batchSize, 1,
                outputSize);
        ...
        DataSetIterator dataSetIteratorTest = new RecordReaderDataSetIterator(recordReaderTest, batchSize, 1,
                outputSize);
